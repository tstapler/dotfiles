...
- **Handle [[Needs Processing]] tags**: If the research task involves content tagged with `[[Needs Processing]]`, recursively process all child bullet points and nested content to ensure full context is captured before beginning research.
