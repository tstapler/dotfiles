...
description: Use when writing, debugging, or designing GitHub Actions composite actions.
  Covers the `uses:` field rules, relative path resolution, composite-to-composite
  calling, secrets limitations, differences from reusable workflows, and best practices.
---
