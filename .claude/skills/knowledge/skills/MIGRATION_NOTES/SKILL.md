---
description: ''
prompt: '# Knowledge Processing Architecture Migration Notes
  ...
  **None required** - the migration is backward compatible. Both old and new commands
  work.
  ...
  **Yes.** Legacy commands are preserved and functional. Use them if you prefer or
  encounter issues with the new orchestrator.


  ### Do I need to change my workflows?

  **No.** Existing workflows using legacy commands continue to work. Transition to
  `/knowledge/enrich` at your convenience.


  ### What if I have custom scripts calling old commands?

  **They still work.** Update scripts at your convenience. The old commands remain
  available.
  ...
  It remains unchanged and can be updated to use `/knowledge/enrich` internally if
  desired.
  ...
  Handler skills are read by the orchestrator and applied to entries. They are NOT
  directly invocable commands - they provide domain knowledge that the orchestrator
  uses.
