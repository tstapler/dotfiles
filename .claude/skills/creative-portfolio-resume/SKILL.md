...
| Skill | When to apply |
|-------|--------------|
| `resume-ats-optimizer` | Validate ATS-compatible version before submission |
| `resume-formatter` | Apply clean layout rules to the ATS version |
| `resume-bullet-writer` | Strengthen achievement bullets in both versions |
| `portfolio-case-study-writer` | Expand portfolio project bullets into full case studies |
| `job-description-analyzer` | Match creative resume content to specific role requirements |
| `resume-tailor` | Adjust content and emphasis per creative job posting |
| `linkedin-profile-optimizer` | Sync portfolio links and creative brand to LinkedIn |
| `pdf-proof` | Proofread designed version before sharing or printing |
| `writing-humanize` | Make AI-drafted copy in the resume sound authentic |
