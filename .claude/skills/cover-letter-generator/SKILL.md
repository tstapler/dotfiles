...
| Skill | When to apply |
|-------|--------------|
| `job-description-analyzer` | Extract talking points and match score before writing |
| `resume-tailor` | Align resume to same job before writing cover letter |
| `interview-prep-generator` | Expand cover letter talking points into interview stories |
| `career-changer-translator` | Address industry pivot in the cover letter body |
| `writing-humanize` | Make AI-generated letter text sound natural |
| `pdf-proof` | Proofread final letter before submission |
| `meta-research-workflow` | Research company news and culture to personalize the hook |
