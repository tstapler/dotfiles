...
description: Diagnose and fix failing Java tests (JUnit 5/4, Spring Test, TestNG, Mockito, AssertJ)
  with root-cause analysis rather than workarounds — includes parsing test reports efficiently
  without reading entire stack traces, and understanding Gradle/Maven build configurations. Use
  when Java tests are failing, flaky, or a CI pipeline test step needs debugging.
---
