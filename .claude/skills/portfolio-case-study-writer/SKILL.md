...
| Skill | When to apply |
|-------|--------------|
| `resume-bullet-writer` | Condense case study results into resume achievement bullets |
| `resume-quantifier` | Find or estimate metrics for the Results section |
| `creative-portfolio-resume` | Integrate case study links into a designed portfolio resume |
| `interview-prep-generator` | Build STAR stories from the case study's Process section |
| `writing-humanize` | Make AI-drafted narrative sections sound natural |
| `pdf-proof` | Proofread final case study before publishing to portfolio |
| `meta-research-workflow` | Research audience expectations for case study depth and format |
