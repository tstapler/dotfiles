...
Write a complete self-contained HTML file. Use the structure below verbatim for the Sankey — substitute `SANKEY_DATA` with the JSON built from parsing (see `SKILL.md` → "Building `SANKEY_DATA`").
