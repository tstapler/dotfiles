---
name: git-worktrees
description: 'Manage git worktrees for isolated feature development. Automatically
  handles directory selection,

  .gitignore safety verification, worktree creation, project setup (npm/cargo/poetry/go),
  and test

  baseline validation. Use when starting new feature branches, working on multiple
  features simultaneously,

  or needing clean isolated environments. Integrates with CLAUDE.md directives and
