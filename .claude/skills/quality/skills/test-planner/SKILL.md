...
prompt: '# Test Planner
  ...
  I''ll analyze your code changes through the lens of the test pyramid and principles
  from Effective Software Testing. I''ll create a comprehensive testing plan focusing
  on:
  ...
  1. Identify portions of the project that need testing based on your description
  ...
  Let me analyze your changes and create a comprehensive testing strategy that ensures
