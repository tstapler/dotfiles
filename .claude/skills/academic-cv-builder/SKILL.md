...
| Skill | When to apply |
|-------|--------------|
| `resume-formatter` | Ensure consistent layout and ATS-safe formatting |
| `resume-bullet-writer` | Strengthen achievement bullets in experience sections |
| `resume-quantifier` | Add metrics to grants, courses taught, and mentoring sections |
| `cover-letter-generator` | Write tailored letters for faculty or postdoc applications |
| `interview-prep-generator` | Prepare for academic job talks and committee interviews |
| `linkedin-profile-optimizer` | Sync academic profile for broader research visibility |
| `pdf-proof` | Proofread final CV before submission |
| `writing-humanize` | Make AI-drafted section text sound natural |
| `meta-research-workflow` | Research department culture and funding priorities before applying |
