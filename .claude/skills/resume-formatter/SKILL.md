...
| Skill | When to apply |
|-------|--------------|
| `resume-ats-optimizer` | Verify keyword placement after layout is finalized |
| `resume-section-builder` | Determine which sections to include and their order |
| `resume-bullet-writer` | Improve bullet content once formatting is clean |
| `creative-portfolio-resume` | Apply creative design rules for non-ATS portfolio version |
| `executive-resume-writer` | Apply 2-3 page executive layout conventions |
| `pdf-proof` | Final proofread after all formatting changes are applied |
