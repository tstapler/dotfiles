...
| Skill | When to apply |
|-------|--------------|
| `resume-tailor` | Align talking points sent to references with tailored resume |
| `job-description-analyzer` | Identify which skills references should emphasize for this role |
| `interview-prep-generator` | Anticipate reference check questions and brief accordingly |
| `pdf-proof` | Proofread the formatted reference list before sending |
