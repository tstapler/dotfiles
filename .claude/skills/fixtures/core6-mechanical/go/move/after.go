// File: internal/repository/user.go (after move)
// Moved from internal/user/repo.go
// All callers updated: import path changed from internal/user to internal/repository
package repository
