...
description: Apply prompting techniques when creating prompts, agents, commands, system
  instructions, or SKILL.md files. Use for XML tags, multishot examples, chain-of-thought,
  response prefilling, and Claude 4-specific patterns.
---
