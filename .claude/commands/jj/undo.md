...
prompt: '# Jujutsu Undo Operations


  You are being invoked to help safely undo operations using Jujutsu''s powerful operation
  log feature.
  ...
  **Remember**: With jj, you can''t break anything permanently. If something goes
  wrong, just `jj undo`!
